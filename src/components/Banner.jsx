const Banner = () => {
    return (
        <div className="bg-color-primary w-11/12 mx-auto md:pb-[16.5rem] pb-[5rem] pt-[2rem] rounded-b-3xl mb-[30rem] flex flex-col items-center">
            ...
            <button className="px-6 py-3 font-bold border-none outline-none text-three text-[1rem] rounded-full bg-white active:scale-[0.9] transition-all duration-300 mt-4">
                Click Me
            </button>
        </div>
    );
